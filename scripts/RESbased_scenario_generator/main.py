...
from RESbased_scenario_generator import demand_statistics
from RESbased_scenario_generator import baseline_pathway_simple
from energy_consumption import generation_system_function
...
def inner_res_based_generator_list_technologies(user_object):
    try:
        #Input from users 
    ...
    return res_based_generator_list_technologies(inputs_users)
