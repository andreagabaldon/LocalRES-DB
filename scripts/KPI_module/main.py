...
def inner_simulation_and_optimisation():
...
building_consumption_dict = KPI_module.generation_system_function(data=data, demand_profile=demand_profile)


def inner_perform_kpis():
    #Calculate primary energy consumption
    total_primary_energy, total_primary_energy_MWh = KPI_module.total_primary_energy_function(data=data, building_consumption_dict=building_consumption_dict)
